# Horror Prototype - Parcial Motores 1
...
* **Eventos RNG y Audio Espacial:** El juego cuenta con un sistema de probabilidad matemática que genera estática en la TV, llamadas perdidas, ruidos en la puerta y apariciones de sombras. El audio espacial (3D) es crucial para ubicar la amenaza.
...
Este proyecto hace un fuerte hincapié en las buenas prácticas de programación en Unity, arquitectura de software y uso de las herramientas del motor:
...
* **Click Izquierdo:** Interactuar con el objeto resaltado por el punto de mira (Lámpara, Celular, TV, Puerta).
* **Barra Espaciadora:** Acostarse/Hacerse un ovillo (Acción de *Ignorar* para evadir sustos directos).
* **ESC:** Desbloquear el cursor.

## 📁 Documentación Adjunta
Dentro de la carpeta `.gemini` y en el repositorio se pueden incluir los documentos que respaldan el diseño y la estabilidad del proyecto:
1. `GDD.md`: Game Design Document completo.
2. `Informe_Testing.md`: Reporte de QA detallando bugs encontrados, exploit fixes y balanceo.
3. `testing_checklist.md`: Plan de pruebas exhaustivas.

---
*Desarrollado para la cátedra de Motores 1 - UTN.*
